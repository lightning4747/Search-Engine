...
ALTER TABLE crawled_pages ADD COLUMN IF NOT EXISTS authority_score DOUBLE PRECISION;
ALTER TABLE crawled_pages ADD COLUMN IF NOT EXISTS doc_fingerprint TEXT;
