/**
 * Static set of common English stopwords for O(1) lookup.
 * This list must be kept consistent between the indexer and the query processor.
 */
...
/**
 * Checks if a given word (case-insensitive) is a stopword.
 * 
